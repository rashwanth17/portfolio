...
const Navbar = () => {
  return (
    ...
    <div className='text-black flex justify-between gap-4 items-center h-full bg-black  w-screen'>
      ...
      <Link to="/#" style={{cursor : "pointer"}} className='bg-indigo-700 border-2 rounded-md w-20 h-[100%] border-indigo-700 text-white flex justify-center items-center'>Profile</Link>
